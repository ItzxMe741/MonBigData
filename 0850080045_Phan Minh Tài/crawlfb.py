...
Original file is located at
    https://colab.research.google.com/drive/1dFx0bZjiI9n_IDzInTaMw_7OTMWlRIak
"""
...
FANPAGE_LINK ="genshinsimpact"
FOLDER_PATH = "/content/drive/MyDrive/CrawlFB/"
COOKIE_PATH = "/content/drive/MyDrive/CrawlFB/www.facebook.com_cookies.txt"
...
path="/content/drive/MyDrive/CrawlFB/genshinsimpact.npy"
post_list = np.load(path,allow_pickle=True)
post_df_full = pd.read_excel("/content/drive/MyDrive/CrawlFB/genshinsimpact.xlsx")
...
post_df_full_with_reactions[['post_text','like','love','haha','wow','care','sad',
...
print(post_df_full_with_reactions[['like','love','haha','wow','care','sad']].corrwith(post_df_full_with_reactions['shares']))
